...
from fastspeech2.base import BaseModel
from fastspeech2.logger import get_visualizer
...
class BaseTrainer:
    ...
    def __init__(self, model: BaseModel, criterion, optimizer, config, device, lr_scheduler=None):
        self.device = device
        self.config = config
